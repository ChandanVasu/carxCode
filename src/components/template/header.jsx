...
const Header = () => {
  ...
  return (
    <>
      <div className='shadow-1 flex justify-between items-center px-4 sm:px-8 md:px-16 z-50 sticky top-0 bg-white'>
        <Link href="/"><img className='h-10 sm:h-14 p-2 cursor-pointer' src="/logo.png" alt="Logo" /></Link>
